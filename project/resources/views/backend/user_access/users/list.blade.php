...
@section('content')
	...
	@component('backend.components.toolbar', ['pages_title' => $pages_title, 'sub_menu' => __('main.user_access'), 'sub_menu_link' => null])
	@endcomponent	
	<!--begin::Content-->
			...
			@component('backend.components.form-modal', ['modal_size' => 'modal-lg', 'modal_id' => $controller])
				@section('form_modal')
					<ul class="nav nav-tabs nav-line-tabs mb-10 fs-6">
						...
						<li class="nav-item">
							<a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_2">Akun</a>
						</li>
					</ul>
					...
					<div class="tab-content" id="myTabContent">
						...
						<div class="tab-pane show active" id="kt_tab_pane_1" role="tabpanel">
							...
							<div class="fv-row mb-7">
								...
								<input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{ __('main.name') }}"  />
							</div>
							<div class="fv-row mb-7">
								<label class="required fw-semibold fs-6 mb-2">{{ __('main.email') }}</label>
								<input type="email" name="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{ __('main.email') }}" />
							</div>
						</div>
						...
						<div class="tab-pane" id="kt_tab_pane_2" role="tabpanel">
							<div class="fv-row mb-7">
								...
								<input type="email" name="username" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{ __('main.username') }}" />
							</div>
							...
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										<input class="form-control form-control-lg form-control-solid" type="password" placeholder="" name="password" autocomplete="new-password"  />
							...
							<div class="mb-7">
								<label class="required fw-semibold fs-6 mb-5">{{ __('main.user_role') }}</label>
								@foreach ($roles as $key => $value)
									<div class="d-flex fv-row">
										<div class="form-check form-check-custom form-check-solid">
											<input class="form-check-input me-3" name="role_id" type="radio" value="{{ $value->id }}" id="kt_modal_update_role_option_{{ $value->id }}" @if($key == 0) checked @endif />
											<label class="form-check-label" for="kt_modal_update_role_option_{{ $value->id }}">
												<div class="fw-bold text-gray-800">{{ $value->display_name }}</div>
												<div class="text-gray-600">{{ $value->description }}</div>
											</label>
										</div>
									</div>
...
@push('private_js')
	...
	<script>
		...
		const URL_API = `{{ url('admin/user_access/users') }}`
